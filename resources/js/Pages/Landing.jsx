            ...
            <div className="relative min-h-screen overflow-hidden">
                ...
                <div className="relative">
                    ...
                    <main className="recruit-shell pb-16 pt-14 lg:pt-20">
                        <div className="grid gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
                            <section className="space-y-8">
                                ...
                                <div className="flex flex-wrap gap-3">
                                    <Link href={auth.user ? route('dashboard') : route('register')} className="rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-950 transition hover:bg-slate-100">
                                        Explore the platform
                                    </Link>
                                    <a href="#platform" className="rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
                                        See product pillars
                                    </a>
                                </div>
                            ...
                            <section className="glass-panel relative overflow-hidden p-5">
                                ...
                                <div className="surface-panel p-5">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            <p className="text-sm font-medium text-sky-300">Hiring pipeline</p>
                                            <h2 className="text-2xl font-bold text-white">Live team snapshot</h2>
                                        </div>
                                        ...
                                        {pipeline.map(([stage, count], index) => (
                                            <div key={stage} className="rounded-2xl border border-white/5 bg-white/[0.03] p-4">
                                                <div className="flex items-center justify-between text-sm">
                                                    ...
                                                    <span className="font-black text-sky-300">{count}</span>
                                                </div>
                                    ...
                                    <div className="mt-5 grid gap-3 sm:grid-cols-2">
                                        <div className="rounded-2xl border border-sky-400/10 bg-sky-400/10 p-4">
                                            <div className="text-xs uppercase tracking-[0.25em] text-sky-300">Automation</div>
                                        ...
                                        <div className="rounded-2xl border border-orange-400/10 bg-orange-400/10 p-4">
                                            <div className="text-xs uppercase tracking-[0.25em] text-orange-200">Reporting</div>
                                            <div className="mt-2 text-sm text-slate-200">
                        ...
                        <section id="operations" className="mt-16 grid gap-4 lg:grid-cols-[1.15fr_0.85fr] lg:mt-24">
                            <article className="surface-panel p-6 lg:p-8">
                                <div className="flex items-center justify-between gap-4">
                                    <div>
                                        <p className="text-sm font-semibold text-sky-300">Operations</p>
                                        <h3 className="text-2xl font-bold text-white">Structured hiring from source to offer</h3>
                                    </div>
                                    <Link href={auth.user ? route('dashboard') : route('login')} className="rounded-full border border-white/10 px-4 py-2 text-sm font-semibold text-slate-200 transition hover:bg-white/10">
                                        Open demo
                                    </Link>
                                </div>
                                ...
                                <div className="mt-6 grid gap-4 md:grid-cols-2">
                                    <div className="rounded-3xl border border-white/5 bg-slate-950/60 p-5">
                                        <div className="text-sm font-semibold text-slate-300">ATS workflow</div>
                                        <p className="mt-3 text-sm leading-7 text-slate-400">
                                            Track requisitions, candidate stages, approvals, and feedback in a single structured workflow.
                                        </p>
                                    </div>
                                    <div className="rounded-3xl border border-white/5 bg-slate-950/60 p-5">
                                        <div className="text-sm font-semibold text-slate-300">Calendar orchestration</div>
                                        <p className="mt-3 text-sm leading-7 text-slate-400">
                            ...
                            <aside className="surface-panel p-6 lg:p-8">
                                <p className="text-sm font-semibold text-orange-300">Insight loop</p>
                                <div className="mt-3 space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="mt-2 h-2 rounded-full bg-white/10">
                                            <div className="h-2 w-[96%] rounded-full bg-gradient-to-r from-sky-400 to-slate-200" />
                                        </div>
                                    </div>
                                    <div>
                                        <div className="flex items-center justify-between text-sm text-slate-400">
                                        ...
                                        <div className="mt-2 h-2 rounded-full bg-white/10">
                                            <div className="h-2 w-[71%] rounded-full bg-gradient-to-r from-orange-400 to-amber-200" />
                                        </div>
                                    </div>
                                </div>
                            </aside>
                        ...
                        <section className="mt-16 rounded-[32px] border border-white/10 bg-gradient-to-r from-sky-400/15 via-white/5 to-orange-400/15 p-8 text-center lg:mt-24 lg:p-12">
                            <p className="text-sm font-semibold uppercase tracking-[0.35em] text-sky-300">Ready to build your hiring stack</p>
                            ...
                            <div className="mt-6 flex flex-wrap justify-center gap-3">
                                ...
                                {canLogin && (
                                    <Link href={route('login')} className="rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-semibold text-white transition hover:bg-white/10">
                                        Log in
                                    </Link>
                                )}
                            </div>
